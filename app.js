...
const AI_PROVIDERS = {
  gemini: {
    ...
    badge: 'Required',
    models: [
      { id: 'gemini-2.0-flash-lite', displayName: 'Gemini 2.0 Flash Lite', version: '2.0', inputTokens: 1048576, outputTokens: 8192, rpm: '30 RPM', rpd: '1,500 RPD', desc: 'Ultra-Fast High Throughput Lite (Google AI)' },
      ...
      { id: 'gemini-2.0-flash', displayName: 'Gemini 2.0 Flash', version: '2.0', inputTokens: 1048576, outputTokens: 8192, rpm: '15 RPM', rpd: '1,500 RPD', desc: 'Stable Production Gemini (Google AI)' },
      { id: 'gemini-2.5-pro', displayName: 'Gemini 2.5 Pro', version: '2.5', inputTokens: 2097152, outputTokens: 8192, rpm: '5 RPM', rpd: '1,000 RPD', desc: 'Flagship Pro Reasoning (Google AI)' },
      { id: 'gemini-1.5-flash', displayName: 'Gemini 1.5 Flash', version: '1.5', inputTokens: 1048576, outputTokens: 8192, rpm: '15 RPM', rpd: '1,500 RPD', desc: 'Reliable Production Flash' },
      { id: 'gemini-1.5-pro', displayName: 'Gemini 1.5 Pro', version: '1.5', inputTokens: 2097152, outputTokens: 8192, rpm: '5 RPM', rpd: '1,000 RPD', desc: 'Pro Deep Context Reasoning' }
    ]
  },
  openrouter: {
    id: 'openrouter',
    ...
    badge: 'Required',
    models: [
      { id: 'google/gemini-2.0-flash-lite', displayName: 'Gemini 2.0 Flash Lite (OpenRouter)', version: '2.0', inputTokens: 1048576, outputTokens: 8192, rpm: 'Dynamic', rpd: 'Unlimited', desc: 'Ultra-Light via OpenRouter' },
      ...
      { id: 'google/gemini-2.0-flash', displayName: 'Gemini 2.0 Flash (OpenRouter)', version: '2.0', inputTokens: 1048576, outputTokens: 8192, rpm: 'Dynamic', rpd: 'Unlimited', desc: 'Ultra-Fast via OpenRouter' },
...
const TRANSLATION_MODEL_RANKING = [
  // ── Tier 1A: Google Gemini (Direct) Lite Models (First Priority) ──
  { providerId: 'gemini', modelId: 'gemini-2.0-flash-lite', name: 'Gemini 2.0 Flash Lite', tier: 'Tier 1A (Gemini Lite)', desc: 'Ultra-Fast 30 RPM Lite (Google AI)' },

  // ── Tier 1B: Google Gemini (Direct) Flash & Pro Models ──
  { providerId: 'gemini', modelId: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', tier: 'Tier 1B (Gemini Flash)', desc: 'Latest Ultra-Fast High Quality (Google AI)' },
  { providerId: 'gemini', modelId: 'gemini-2.0-flash', name: 'Gemini 2.0 Flash', tier: 'Tier 1B (Gemini Flash)', desc: 'Stable Production Gemini (Google AI)' },
  { providerId: 'gemini', modelId: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', tier: 'Tier 1B (Gemini Pro)', desc: 'Next-Gen Flagship Pro Reasoning (Google AI)' },
  { providerId: 'gemini', modelId: 'gemini-1.5-flash', name: 'Gemini 1.5 Flash', tier: 'Tier 1B (Gemini Flash)', desc: 'Reliable Production Flash (Google AI)' },
  { providerId: 'gemini', modelId: 'gemini-1.5-pro', name: 'Gemini 1.5 Pro', tier: 'Tier 1B (Gemini Pro)', desc: 'Pro Deep Context Reasoning (Google AI)' },

  // ── Tier 2A: OpenRouter Gemini Lite Models (First Priority for OpenRouter Gemini) ──
  { providerId: 'openrouter', modelId: 'google/gemini-2.0-flash-lite', name: 'Gemini 2.0 Flash Lite (OpenRouter)', tier: 'Tier 2A (OpenRouter Gemini Lite)', desc: 'Ultra-Light via OpenRouter' },
  { providerId: 'openrouter', modelId: 'google/gemini-3.0-flash-lite', name: 'Gemini 3.0 Flash Lite (OpenRouter)', tier: 'Tier 2A (OpenRouter Gemini Lite)', desc: 'Ultra-Light via OpenRouter' },

  // ── Tier 2B: OpenRouter Gemini Flash & Pro Models ──
  { providerId: 'openrouter', modelId: 'google/gemini-2.5-flash', name: 'Gemini 2.5 Flash (OpenRouter)', tier: 'Tier 2B (OpenRouter Gemini Flash)', desc: 'Next-Gen Speed via OpenRouter' },
  { providerId: 'openrouter', modelId: 'google/gemini-2.0-flash', name: 'Gemini 2.0 Flash (OpenRouter)', tier: 'Tier 2B (OpenRouter Gemini Flash)', desc: 'Ultra-Fast via OpenRouter' },
  { providerId: 'openrouter', modelId: 'google/gemini-2.5-pro', name: 'Gemini 2.5 Pro (OpenRouter)', tier: 'Tier 2B (OpenRouter Gemini Pro)', desc: 'Top Nuance via OpenRouter' },

  // ── Tier 2C: OpenRouter Other Top Cinematic / Dialogue AI Models ──
  { providerId: 'openrouter', modelId: 'deepseek/deepseek-chat', name: 'DeepSeek V3 (OpenRouter)', tier: 'Tier 2C (OpenRouter DeepSeek)', desc: 'Top Cinematic Dialogue & Idioms' },
  { providerId: 'openrouter', modelId: 'meta-llama/llama-3.3-70b-instruct', name: 'Meta Llama 3.3 70B (OpenRouter)', tier: 'Tier 2C (OpenRouter Llama)', desc: 'Natural Conversational Flow' },
  { providerId: 'openrouter', modelId: 'anthropic/claude-3.5-haiku', name: 'Claude 3.5 Haiku (OpenRouter)', tier: 'Tier 2C (OpenRouter Claude)', desc: 'Natural Spoken Dubbing' },
  { providerId: 'openrouter', modelId: 'deepseek/deepseek-r1', name: 'DeepSeek R1 (OpenRouter)', tier: 'Tier 2C (OpenRouter Reasoning)', desc: 'Deep Reasoning for Ambiguous Lines' },
...
async function verifyAndLoadProvider(providerId, key) {
  ...
  try {
    ...
    if (providerId === 'gemini') {
      ...
      // Dynamic real-time sorting by mathematical version number descending; Lite models prioritized first
      textModels.sort((a, b) => {
        const idA = a.name.replace(/^models\//, '').toLowerCase();
        const idB = b.name.replace(/^models\//, '').toLowerCase();
        const score = (id) => {
          if (id.includes('lite')) return 3;
          if (id.includes('flash')) return 2;
          if (id.includes('pro')) return 1;
          return 0;
        };
        const scoreDiff = score(idB) - score(idA);
...
function resolveRealTimeBestModel() {
  ...
  // 1. Phase 1: Google Gemini Lite Models (First Priority: Highest Version to Lowest, Dynamic)
  if (state.apiKeys.gemini && state.providerStatus.gemini?.connected !== false) {
    ...
    // 2. Phase 2: Google Gemini Pro & Flash Models (Highest Version to Lowest, Dynamic)
  ...
  // 3. Phase 3: OpenRouter Gemini Lite Models (First Priority for OpenRouter: Highest Version to Lowest, Dynamic)
  if (state.apiKeys.openrouter && state.providerStatus.openrouter?.connected !== false) {
    ...
    // 4. Phase 4: OpenRouter Gemini Pro & Flash Models (Highest Version to Lowest, Dynamic)
  ...
  // 5. Phase 5: Non-Gemini models from TRANSLATION_MODEL_RANKING (OpenRouter DeepSeek/Llama/Claude -> Groq -> DeepSeek Official -> OpenAI -> Custom)
  ...
  // 6. Fallback to other connected providers
...
function findFailoverBackup(currentProviderId, currentModelId) {
  ...
  // ── RULE 1: Google Gemini Lite (First Priority: Highest Version to Lowest, Dynamic) ──
    ...
    for (const mId of liteList) {
      if (isModelHealthy('gemini', mId)) {
        ...
        return {
          ...
          tier: 'Tier 1A (Gemini Lite)',
          desc: mObj.desc || 'Ultra-Fast Lite Translation',
          key: state.apiKeys.gemini
        };
      }
    }

    // ── RULE 2: Google Gemini Pro & Flash (Highest Version to Lowest, Dynamic) ──
    const proFlashList = getAllGeminiProFlashModels('gemini');
    for (const mId of proFlashList) {
      if (isModelHealthy('gemini', mId)) {
        const mObj = (AI_PROVIDERS.gemini.models || []).find(m => m.id === mId) ||
  ...
  // ── RULE 3: OpenRouter Gemini Lite (First Priority: Highest Version to Lowest, Dynamic) ──
  if (state.providerStatus.openrouter?.connected && state.apiKeys.openrouter) {
    ...
    // ── RULE 4: OpenRouter Gemini Pro/Flash (Highest Version to Lowest, Dynamic) ──
    const orProFlash = getAllGeminiProFlashModels('openrouter');
    for (const mId of orProFlash) {
      if (isModelHealthy('openrouter', mId)) {
        const mObj = (AI_PROVIDERS.openrouter.models || []).find(m => m.id === mId) ||
        ...
        return {
          ...
          model: mId,
          modelName: mObj.displayName || mId,
          tier: 'Tier 2B (OpenRouter Gemini Pro/Flash)',
...
OUTPUT (JSON Array):`;
  ...
  const timeoutId = setTimeout(() => {
    abortController.abort(new Error(`Gemini API request timed out (${timeoutMs / 1000}s network timeout)`));
  }, timeoutMs);
  ...
  try {
    ...
    if (netErr.name === 'AbortError' || abortController.signal.aborted) {
      ...
      throw new Error(`Gemini API timeout (${timeoutMs / 1000}s network timeout). Switching to backup model.`);
    }
...
const LANGUAGE_FLAGS_SVG = {
  'Afrikaans': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="12" fill="#DE3831"/><rect y="12" width="36" height="12" fill="#002395"/><path d="M0,0 L16,12 L36,12 M0,24 L16,12" stroke="#FFF" stroke-width="6" fill="none"/><path d="M0,0 L16,12 L36,12 M0,24 L16,12" stroke="#007A4D" stroke-width="3.6" fill="none"/><polygon points="0,2 13,12 0,22" fill="#FFB612"/><polygon points="0,3.5 11,12 0,20.5" fill="#000"/></svg>',
  'Albanian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#E41E20"/><path d="M18 6l-2 3-3-1 2 4-3 2 4 1-1 3 3-1 0 3 1-2 1 2 0-3 3 1-1-3 4-1-3-2 2-4-3 1z" fill="#000"/><circle cx="16" cy="7" r="1.2" fill="#000"/><circle cx="20" cy="7" r="1.2" fill="#000"/></svg>',
  ...
  'Armenian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#D90012"/><rect y="8" width="36" height="8" fill="#0033A0"/><rect y="16" width="36" height="8" fill="#F2A800"/></svg>',
  'Assamese': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#FF9933"/><rect y="8" width="36" height="8" fill="#FFFFFF"/><rect y="16" width="36" height="8" fill="#138808"/><circle cx="18" cy="12" r="3" fill="none" stroke="#000080" stroke-width="0.8"/><circle cx="18" cy="12" r="0.6" fill="#000080"/></svg>',
  ...
  'Basque': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="6" fill="#AA151B"/><rect y="6" width="36" height="12" fill="#F1BF00"/><rect y="18" width="36" height="6" fill="#AA151B"/><rect x="8" y="9" width="4" height="6" fill="#AA151B" rx="1"/><rect x="8.8" y="10" width="2.4" height="4" fill="#F1BF00"/></svg>',
  ...
  'Bosnian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#002395"/><polygon points="9,0 26,0 26,24" fill="#FECB00"/><circle cx="8" cy="2" r="1" fill="#FFF"/><circle cx="10" cy="5" r="1" fill="#FFF"/><circle cx="12" cy="8" r="1" fill="#FFF"/><circle cx="14" cy="11" r="1" fill="#FFF"/><circle cx="16" cy="14" r="1" fill="#FFF"/><circle cx="18" cy="17" r="1" fill="#FFF"/><circle cx="20" cy="20" r="1" fill="#FFF"/><circle cx="22" cy="23" r="1" fill="#FFF"/></svg>',
  ...
  'Catalan': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="6" fill="#AA151B"/><rect y="6" width="36" height="12" fill="#F1BF00"/><rect y="18" width="36" height="6" fill="#AA151B"/><rect x="8" y="9" width="4" height="6" fill="#AA151B" rx="1"/><rect x="8.8" y="10" width="2.4" height="4" fill="#F1BF00"/></svg>',
  ...
  'Estonian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#0072CE"/><rect y="8" width="36" height="8" fill="#000000"/><rect y="16" width="36" height="8" fill="#FFFFFF"/></svg>',
  ...
  'Galician': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="6" fill="#AA151B"/><rect y="6" width="36" height="12" fill="#F1BF00"/><rect y="18" width="36" height="6" fill="#AA151B"/><rect x="8" y="9" width="4" height="6" fill="#AA151B" rx="1"/><rect x="8.8" y="10" width="2.4" height="4" fill="#F1BF00"/></svg>',
  'Georgian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#FFFFFF"/><rect x="15.5" width="5" height="24" fill="#FF0000"/><rect y="9.5" width="36" height="5" fill="#FF0000"/><path d="M7 4v3m-1.5-1.5h3 M29 4v3m-1.5-1.5h3 M7 17v3m-1.5-1.5h3 M29 17v3m-1.5-1.5h3" stroke="#FF0000" stroke-width="1.2" stroke-linecap="round"/></svg>',
  ...
  'Icelandic': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#02529C"/><rect x="9" width="6" height="24" fill="#FFF"/><rect y="9" width="36" height="6" fill="#FFF"/><rect x="10.5" width="3" height="24" fill="#DC1E35"/><rect y="10.5" width="36" height="3" fill="#DC1E35"/></svg>',
  'Igbo': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="12" height="24" fill="#008751"/><rect x="12" width="12" height="24" fill="#FFFFFF"/><rect x="24" width="12" height="24" fill="#008751"/></svg>',
  ...
  'Irish': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="12" height="24" fill="#169B62"/><rect x="12" width="12" height="24" fill="#FFFFFF"/><rect x="24" width="12" height="24" fill="#FF883E"/></svg>',
  ...
  'Kannada': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#FF9933"/><rect y="8" width="36" height="8" fill="#FFFFFF"/><rect y="16" width="36" height="8" fill="#138808"/><circle cx="18" cy="12" r="3" fill="none" stroke="#000080" stroke-width="0.8"/><circle cx="18" cy="12" r="0.6" fill="#000080"/></svg>',
  ...
  'Kurdish': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#CE1126"/><rect y="8" width="36" height="8" fill="#FFFFFF"/><rect y="16" width="36" height="8" fill="#000000"/><text x="18" y="14" font-size="5" font-weight="bold" fill="#007A3D" text-anchor="middle" font-family="sans-serif">الله أكبر</text></svg>',
  'Kyrgyz': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#E8112D"/><circle cx="18" cy="12" r="5" fill="#FFE600"/><circle cx="18" cy="12" r="3.5" fill="#E8112D"/><circle cx="18" cy="12" r="2.8" fill="none" stroke="#FFE600" stroke-width="0.8"/><path d="M15.5 12h5 M18 9.5v5" stroke="#FFE600" stroke-width="0.8"/></svg>',
  'Lao': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="6" fill="#CE1126"/><rect y="6" width="36" height="12" fill="#002868"/><rect y="18" width="36" height="6" fill="#CE1126"/><circle cx="18" cy="12" r="4.5" fill="#FFFFFF"/></svg>',
  'Latvian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#9E3039"/><rect y="9.6" width="36" height="4.8" fill="#FFFFFF"/></svg>',
  'Lithuanian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#FDB913"/><rect y="8" width="36" height="8" fill="#006A44"/><rect y="16" width="36" height="8" fill="#C1272D"/></svg>',
  'Macedonian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#D20000"/><polygon points="18,12 0,0 6,0" fill="#FFE600"/><polygon points="18,12 36,0 30,0" fill="#FFE600"/><polygon points="18,12 36,24 30,24" fill="#FFE600"/><polygon points="18,12 0,24 6,24" fill="#FFE600"/><polygon points="18,12 16,0 20,0" fill="#FFE600"/><polygon points="18,12 16,24 20,24" fill="#FFE600"/><polygon points="18,12 0,10 0,14" fill="#FFE600"/><polygon points="18,12 36,10 36,14" fill="#FFE600"/><circle cx="18" cy="12" r="4" fill="#D20000"/><circle cx="18" cy="12" r="3.2" fill="#FFE600"/></svg>',
  'Malagasy': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="12" height="24" fill="#FFFFFF"/><rect x="12" width="24" height="12" fill="#FC3D32"/><rect x="12" y="12" width="24" height="12" fill="#007E3A"/></svg>',
  ...
  'Maltese': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="18" height="24" fill="#FFFFFF"/><rect x="18" width="18" height="24" fill="#CF142B"/><rect x="2.5" y="2.5" width="4" height="4" fill="#E6E6E6" stroke="#8A8D8F" stroke-width="0.8"/><circle cx="4.5" cy="4.5" r="1.2" fill="#8A8D8F"/></svg>',
  ...
  'Mongolian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="12" height="24" fill="#DA2032"/><rect x="12" width="12" height="24" fill="#0036A7"/><rect x="24" width="12" height="24" fill="#DA2032"/><circle cx="6" cy="12" r="2" fill="#FFD700"/><polygon points="6,6 4,8 8,8" fill="#FFD700"/><rect x="3" y="9" width="6" height="1" fill="#FFD700"/><rect x="3" y="14" width="6" height="1" fill="#FFD700"/></svg>',
  ...
  'Sindhi': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#115E32"/><rect width="9" height="24" fill="#FFFFFF"/><circle cx="22.5" cy="12" r="5" fill="#FFF"/><circle cx="24" cy="10.8" r="4.2" fill="#115E32"/><polygon points="24,9 24.8,10.4 26.2,9.8 25.4,11.2 26.5,12.2 25,12 24.5,13.4 23.8,12.2 22.4,12.4 23.2,11.2" fill="#FFF"/></svg>',
  ...
  'Slovenian': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#FFFFFF"/><rect y="8" width="36" height="8" fill="#005CE6"/><rect y="16" width="36" height="8" fill="#ED1C24"/><path d="M8 5h4v5a2 2 0 0 1-4 0z" fill="#005CE6" stroke="#ED1C24" stroke-width="0.6"/><polygon points="10,6.5 9,8.5 11,8.5" fill="#FFF"/></svg>',
  'Somali': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#4189DD"/><polygon points="18,5 19.8,10.6 25.6,10.6 20.9,14 22.7,19.6 18,16.2 13.3,19.6 15.1,14 10.4,10.6 16.2,10.6" fill="#FFFFFF"/></svg>',
  ...
  'Tajik': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="6.5" fill="#CC0000"/><rect y="6.5" width="36" height="11" fill="#FFFFFF"/><rect y="17.5" width="36" height="6.5" fill="#009900"/><path d="M15 13h6l-1-2.5-2 1-2-1z" fill="#F8C300"/><circle cx="18" cy="9.5" r="0.8" fill="#F8C300"/><circle cx="15.5" cy="10.2" r="0.6" fill="#F8C300"/><circle cx="20.5" cy="10.2" r="0.6" fill="#F8C300"/></svg>',
  ...
  'Turkmen': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#239E54"/><rect x="4" width="6" height="24" fill="#D22630"/><circle cx="16" cy="7" r="3" fill="#FFFFFF"/><circle cx="17.2" cy="7" r="2.6" fill="#239E54"/><circle cx="14" cy="5" r="0.6" fill="#FFFFFF"/><circle cx="15.5" cy="4.2" r="0.6" fill="#FFFFFF"/><circle cx="17" cy="4.2" r="0.6" fill="#FFFFFF"/></svg>',
  ...
  'Welsh': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#012169"/><path d="M0,0 L36,24 M36,0 L0,24" stroke="#FFF" stroke-width="4"/><path d="M0,0 L36,24 M36,0 L0,24" stroke="#C8102E" stroke-width="2"/><rect x="15" width="6" height="24" fill="#FFF"/><rect y="9" width="36" height="6" fill="#FFF"/><rect x="16.5" width="3" height="24" fill="#C8102E"/><rect y="10.5" width="36" height="3" fill="#C8102E"/></svg>',
  'Xhosa': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="12" fill="#DE3831"/><rect y="12" width="36" height="12" fill="#002395"/><path d="M0,0 L16,12 L36,12 M0,24 L16,12" stroke="#FFF" stroke-width="6" fill="none"/><path d="M0,0 L16,12 L36,12 M0,24 L16,12" stroke="#007A4D" stroke-width="3.6" fill="none"/><polygon points="0,2 13,12 0,22" fill="#FFB612"/><polygon points="0,3.5 11,12 0,20.5" fill="#000"/></svg>',
  'Yoruba': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="12" height="24" fill="#008751"/><rect x="12" width="12" height="24" fill="#FFFFFF"/><rect x="24" width="12" height="24" fill="#008751"/></svg>',
  'Zulu': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="12" fill="#DE3831"/><rect y="12" width="36" height="12" fill="#002395"/><path d="M0,0 L16,12 L36,12 M0,24 L16,12" stroke="#FFF" stroke-width="6" fill="none"/><path d="M0,0 L16,12 L36,12 M0,24 L16,12" stroke="#007A4D" stroke-width="3.6" fill="none"/><polygon points="0,2 13,12 0,22" fill="#FFB612"/><polygon points="0,3.5 11,12 0,20.5" fill="#000"/></svg>'
};
...
function showToast(message, type = 'success') {
  ...
  // Prevent multiple stacked/overlapping toasts — dismiss existing toasts immediately
  const existingToasts = container.querySelectorAll('.subsync-toast');
  existingToasts.forEach(oldToast => {
    oldToast.classList.remove('toast-show');
  ...
  const displayTime = cleanMsg.length > 35 ? 3200 : 2400;
...
function initKeyboardVisibilityHandler() {
  ...
  document.addEventListener('touchstart', (e) => {
    if (isTextInputFocused()) {
      ...
      if (active && !active.contains(e.target) && e.target !== active && !e.target.closest('.custom-select-search-wrap') && !e.target.closest('button') && !e.target.closest('.action-btn')) {
        active.blur();
        setKeyboardState(false);
      }
    }
