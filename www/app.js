...
const LANGUAGE_FLAGS_SVG = {
  ...
  'Assamese': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#D21034"/><rect x="2" y="2" width="32" height="20" fill="none" stroke="#FFF" stroke-width="1.2" stroke-dasharray="2 1"/><circle cx="18" cy="12" r="6" fill="#FFF"/><circle cx="18" cy="12" r="5" fill="#D21034"/><polygon points="18,8 21,14 15,14" fill="#FFD700"/><circle cx="18" cy="12" r="1.5" fill="#FFF"/></svg>',
  ...
  'Basque': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#DA291C"/><path d="M0,0 L36,24 M36,0 L0,24" stroke="#009543" stroke-width="4.5"/><rect x="15.5" width="5" height="24" fill="#FFF"/><rect y="9.5" width="36" height="5" fill="#FFF"/></svg>',
  ...
  'Catalan': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#FFD100"/><rect y="2.67" width="36" height="2.67" fill="#ED1624"/><rect y="8" width="36" height="2.67" fill="#ED1624"/><rect y="13.33" width="36" height="2.67" fill="#ED1624"/><rect y="18.67" width="36" height="2.67" fill="#ED1624"/></svg>',
  ...
  'Galician': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#FFFFFF"/><polygon points="0,6 27,24 36,24 9,0 0,0" fill="#007AC1"/></svg>',
  ...
  'Igbo': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="12" height="24" fill="#008751"/><rect x="12" width="12" height="24" fill="#FFFFFF"/><rect x="24" width="12" height="24" fill="#008751"/><circle cx="18" cy="12" r="3.5" fill="#FCD116"/><path d="M18 6v2 M18 16v2 M12 12h2 M22 12h2 M14 8l1.5 1.5 M20.5 14.5l1.5 1.5 M14 16l1.5-1.5 M20.5 9.5l1.5-1.5" stroke="#FCD116" stroke-width="0.8"/></svg>',
  ...
  'Kurdish': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="8" fill="#ED1C24"/><rect y="8" width="36" height="8" fill="#FFFFFF"/><rect y="16" width="36" height="8" fill="#278E43"/><circle cx="18" cy="12" r="3.5" fill="#FFC107"/><circle cx="18" cy="12" r="4.5" fill="none" stroke="#FFC107" stroke-width="0.8" stroke-dasharray="1 1"/></svg>',
  ...
  'Sindhi': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="24" fill="#8B0000"/><rect x="2" y="2" width="32" height="20" fill="none" stroke="#FFFFFF" stroke-width="0.8" stroke-dasharray="2 1"/><circle cx="18" cy="12" r="5" fill="#FFFFFF"/><circle cx="19.5" cy="11.2" r="4.2" fill="#8B0000"/><polygon points="20,10 20.8,11.2 22.2,10.6 21.4,12 22.5,13 21,12.8 20.5,14.2 19.8,13 18.4,13.2 19.2,12" fill="#FFFFFF"/></svg>',
  ...
  'Welsh': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="36" height="12" fill="#FFFFFF"/><rect y="12" width="36" height="12" fill="#00AB39"/><path d="M14 9c2-2 5-1 6 1l3-1c-1 3-3 4-2 6l-3 1c-1-2-2-1-4 0l-1-2 2-2z" fill="#D4351C"/><polygon points="23,9 26,8 24,11" fill="#D4351C"/></svg>',
  ...
  'Yoruba': '<svg class="lang-flag-svg" viewBox="0 0 36 24"><rect width="12" height="24" fill="#008751"/><rect x="12" width="12" height="24" fill="#FFFFFF"/><rect x="24" width="12" height="24" fill="#008751"/><circle cx="18" cy="12" r="3" fill="#FFB81C"/><path d="M16 11l2-3 2 3-1 2h-2z" fill="#008751"/></svg>',
